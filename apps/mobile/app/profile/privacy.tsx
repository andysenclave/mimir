// MM-036 — Privacy settings placeholder (MM-058 fills this in Sprint 4).
  ...
  return (
    <ScreenContainer edges={['top', 'left', 'right']}>
      <View className="flex-row items-center gap-3 px-4 py-4 border-b border-border-subtle">
        ...
        <Text className="text-lg font-bold text-text-primary">Privacy</Text>
      </View>
      <View className="flex-1 items-center justify-center gap-2 px-6">
        <Text className="text-text-secondary text-sm text-center">
          Privacy settings land in Sprint 4 (MM-058).
        </Text>
        <Text className="text-text-tertiary text-xs text-center">
          Your data is stored in India (ap-south-1) per DPDP Act 2023.
        </Text>
      </View>
    </ScreenContainer>
  );
