...
const md = StyleSheet.create({
  ...
  heading1: { color: tokens.text.primary, fontSize: 20, fontWeight: '700', marginTop: 20, marginBottom: 8 },
  heading2: { color: tokens.text.primary, fontSize: 17, fontWeight: '600', marginTop: 16, marginBottom: 6 },
  heading3: { color: tokens.text.primary, fontSize: 15, fontWeight: '600', marginTop: 12, marginBottom: 4 },
  ...
  th: { backgroundColor: tokens.bg.secondary, padding: 8, fontWeight: '600', color: tokens.text.primary },
